...
Elseif Command_token_high = 2 Then
      ...
      Elseif Command_token_low < &H77 Then
         Command_token_low = Command_token_low - &H40
         On Command_token_low Gosub 240,241,242,243,244,245,246,247,248,249,24A,24B,24C,24D,24E,24F,250,251,252,253,254,255,256,257,258,259,25A,25B,25C,25D,25E,25F,260,261,262,263,264,265,266,267,268,269,26A,26B,26C,26D,26E,26F,270,271,272,273,274,275,276
      Else
           Gosub Command_received
      End If
Elseif Command_token_high = &HFF Then
      ' for FFFx commands
      B_temp1 = Command_token_low  - &HF0
