...
' IC2 Adress in resetand announcements
'
...
Const No_of_announcelines = 14                              'announcements start with 0 -> minus 1
'
...
If A = 1 Then
   A = Waitkey()
   If no_myc = 1 Then
      If A = 128 Then                                        'switch to myc mode again
         no_myc=0
         no_myc_eeram =no_myc
         Ir = 255
      Else
         If A >47  AND A < 58 Then                          '2 figures 0 to 9
            If Ir = 255 Then
               Ir =  A -48
               Ir= Ir * 10
            Else
...
'
      Case 1
'Befehl &H01   0-63     als RC5 Signal senden 1 Zeichen
'                       send 1 IR signal
'Data "1;oa, send RC5;b,0 to 63"
...
'
      Case 2
'Befehl &H02   0-255    als RC6 Signal senden, 8 bit
...
'Data "240;am,ANNOUNCEMENTS;160;14"
         If Commandpointer = 2 Then
