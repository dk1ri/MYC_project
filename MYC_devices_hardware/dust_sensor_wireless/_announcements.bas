...
Data "0;m;DK1RI;dust sensor;V03.4;1;145;1;47;1-1"
'
'Announce1:
'Befehl &H01
...
'liest Konzentration 1.0
'read concentration 1.0
Data "2;an,mass concentration 1.0;w,ug/cbm;700,start at,{10,MUL100,};28,to send"
'
'Announce3:
'Befehl &H03
...
'liest Konzentration 2.5
'read concentration 2.5
Data "4;an,mass concentration 2.5;w,ug/cbm;700,start at,{10,MUL100,};28,to send"
'
Announce5:
'Befehl &H05
...
'liest Konzentration 4.0
'read concentration 4.0
Data "6;an,mass concentration 4.0;w,ug/cbm;700,start at,{10,MUL100,};28,to send"
'
'Announce7:
'Befehl &H07
...
'liest Konzentration 10
'read concentration 10
Data "8;an,mass concentration 10;w,ug/cbm;700,start at,{10,MUL100,};28,to send"
'
'Announce9:
'Befehl &H09
...
'liest Konzentration 0.5
'read concentration 0.5
Data "10;an,number concentration 0.5;w,/cbm;700,start at,{10,MUL100,};28,to send"
'
'Announce11:
'Befehl &H0B
'liest Konzentration 1.0
...
'liest Konzentration 1.0
'read concentration 1.0
Data "12;an,number concentration 1.0;w,/cbm;700,start at,{10,MUL100,};28,to send"
...
'liest Konzentration 2.5
'read concentration 2.5
Data "14;an,number concentration 2.5;w,/cbm;700,start at,{10,MUL100,};28,to send"
'
'Announce15:
'Befehl &H0F
'liest Konzentration 4.0
...
'liest Konzentration 4.0
'read concentration 4.0
Data "16;an,number concentration 4.0;w,/cbm;700,start at,{10,MUL100,};28,to send"
'
'Announce17:
'Befehl &H11
...
'liest Konzentration 10
'read concentration 10
Data "18;an,number concentration 10;w,/cbm;700,start at,{10,MUL100,};28,to send"
'
'Announce19:
'Befehl &H13
'typische Groese
...
'typische Groese
'typical size
Data "20;an,typical size;w,um;700,start at,{10,MUL100,};28,to send"
'
'Announce21:
'Befehl &H15
'memorypointer
...
Data "240;an,ANNOUNCEMENTS;145;47,start at;47,elements;14,CHAPTER,ADMINISTRATION"
'
'Announce34:
'Befehl &HF8
'MYC / Interface Mode
'MYC / Interface mode
Data "248;oa,TRANS,transpatent MYC mode / radio name;4"
'
'Announce35:
'Befehl &HFC
...
Data "254;oa,INDIVIDUALIZATION;20,NAME,Device 1;b,NUMBER,1;a,I2C,1;b,ADRESS,28,{1_0to127};a,SERIAL,1;a,RADIO,1;14,CHAPTER,ADMINISTRATION"
'
'Announce38:
'Befehl &HFF <n>
'eigene Individualisierung lesen
'read individualization
Data "255;aa,INDIVIDUALIZATION;20,NAME,Device 1;b,NUMBER,1;a,I2C,1;b,ADRESS,28,{1_0to127};a,SERIAL,1;b,BAUDRATE,0,{19200};3,NUMBER_OF_BITS,8n1;a,RADIO,1;14,CHAPTER,ADMINISTRATION"
'
'Announce39;
