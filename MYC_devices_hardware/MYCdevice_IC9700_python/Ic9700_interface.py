"""
name : Ic9700_interface.py
Version 01.4, 20211020
Purpose : Program to control the IC-9700 radio
...
To run the program the radio should be set to the main band only mode, because the frequencies of the sub
band cannot be used in the main band.
The command to set sub band (&H07d201) will not work.
