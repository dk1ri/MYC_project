...
def commands_at_start():
    if v_icom_vars.command_at_start_continue == 1:
        ...
        if v_icom_vars.command_at_start == 1:
            # echo off
            v_icom_vars.Civ_out = bytearray([0xfe, 0xfe, v_icom_vars.civ_address, 0xe0, 0x1a, 0x05, 0x01, 0x30, 0x00, 0xfd])
        elif v_icom_vars.command_at_start == 2:
            # transceive
            v_icom_vars.Civ_out = bytearray([0xfe, 0xfe, v_icom_vars.civ_address, 0xe0, 0x1a, 0x05, 0x01, 0x27, 0x01, 0xfd])
        elif v_icom_vars.command_at_start == 3:
            # FM
            v_icom_vars.Civ_out = bytearray([0xfe, 0xfe, v_icom_vars.civ_address, 0xe0, 0x06, 0x01, 0x05, 0xfd])
