'name : homematic_RE8.bas
'Version V07.0, 20231001
'purpose : Programm for receiving Homematic signal with HM-MOD-RE8 or HmIP-MOD-OC8
'Can be used with hardware homematic_interface V01.1 by DK1RI
'
'This firmware isr identical to the HmIP-MOD-OC8 Firmware, but this do not have the learn function
'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
