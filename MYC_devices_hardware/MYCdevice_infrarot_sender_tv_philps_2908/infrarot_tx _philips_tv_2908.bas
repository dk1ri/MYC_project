...
'Data "0;m;DK1RI;philips_tv_2908;V02.0;1;160;42;47"
         A_line = 0
         Gosub Sub_restore
         Gosub Command_received
'
...
'                               wird aber ignoriert.
'
'Data "254;oa,INDIVIDUALIZATION;20,NAME,Device 1;b,NUMBER,1;3,INTERFACETYPE,I2C;b,ADRESS,15;INTERFACETYPE,RS232;IF_PARAMETER1,19200Bd;IF_PARAMETER2,8n1;INTERFACETYPE,USB"
         If Commandpointer >= 2 Then
            Select Case Command_b(2)
               Case 0
                  If Commandpointer = 2 Then
