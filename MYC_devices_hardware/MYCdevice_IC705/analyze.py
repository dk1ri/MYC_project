    ...
    if v_icom_vars.Civ_in[0:6] == v_icom_vars.nok_msg:
        ...
        if civ_command < 20:
            ...
            if subcommand1 < 5:
                ...
                if find_token(v_icom_vars.Civ_in[4:6]) == 1:
                    v_icom_vars.civ_command_length = 13
            ...
            if find_token(v_icom_vars.Civ_in[4:7]) == 1:
                ...
                if subcommand1 == 0x00:
                    ...
                    subcommand2 = int.from_bytes(v_icom_vars.Civ_in[6:7], byteorder='big', signed=False)
                    finish = v_command_answer.answer_2010[subcommand2](v_icom_vars.Civ_in)
                elif subcommand1 == 0x02:
                    subcommand2 = int.from_bytes(v_icom_vars.Civ_in[6:7], byteorder='big', signed=False)
                    finish = v_command_answer.answer_2020[subcommand2](v_icom_vars.Civ_in)
                elif subcommand1 == 0x04:
                    subcommand2 = int.from_bytes(v_icom_vars.Civ_in[6:7], byteorder='big', signed=False)
                    finish = v_command_answer.answer_2040[subcommand2](v_icom_vars.Civ_in)
            ...
            if subcommand1 == 1:
                ...
                if find_token(v_icom_vars.Civ_in[4:6]) == 1:
                    finish = v_command_answer.answer_22_0_2_5[subcommand1](v_icom_vars.Civ_in)
