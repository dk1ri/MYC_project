...
Data "0;m;DK1RI;MFJ RBC Interface(TM);V07.0;1;175;1;61;1-1"
'
'Announce1:
'Befehl &H01
'setzt FrequenzVFO A, command * VFOA  *
'set frequency
Data "1;op,set frequency A;1;10000000;lin;Hz"
'
'Announce2:
'Befehl &H02
'setzt Frequenz VFO B, command * VFOB #
'set frequency
Data "2;op,set frequency B;1;10000000;lin;Hz"
'
'Announce3:
'Befehl &H03
...
'set memory
Data "7;op,set memory;1;100;lin;-"
'
'Announce8:
'Befehl &H08   0 to 99
'recall memory, command #1 9 x x
'recall memory
Data "8;op,recall memory;1;100;lin;-"
'
'Announce9:
'Befehl &H09
...
' Rotate Ant1
Data "16;op,rotate Antenna 1;1;360;lin;deg"
'
'Announce17:
'Befehl &H11
'0 to 359 dreht Antenne2, command #2 5 x x x
'Rotate Ant2
Data "17;op,rotate Antenna 2;1;360;lin;deg"
'
'Announce18:
'Befehl &H12
...
'Auto notch
Data"23;ou,Auto Notch;1;0,idle;1,auto notch"
'
'Announce24:
'Befehl &H18   0 to 2
...
'set tone frequency
Data "33;op,tone frequency;1;1000,{0,10to999,9};lin;Hz"
'
'Announce34:
'Befehl &H22   0 to 2
...
'number of ring
Data"47;op,number of ring;1;10;lin;-"
'
'Announce48:
'Befehl &H30   0 to 9999
'passwort festlegen, command #5 4 x x x x
'set password
Data"48;oa,set password;L,{1_0to9999}"
'
'Announce49:
'Befehl &H31
...
'write DTMF length
Data "52;oa,DTMF Duration;b;13,CHAPTER,configuration"
'
'Announce53:
'Befehl &H35
'Dtmf duration lesen
'read DTMF Laenge
Data "23;aa,as52;13,CHAPTER,configuration"
'
'Announce54:
'Befehl &H36
'Dtmf Pause schreiben
'write DTMF Pause
Data "54;oa,DTMF Pause;b;13,CHAPTER,configuration"
'
'Announce55:
'Befehl &H37
'Dtmf Pause lesen
'read DTMF Pause
Data "55;aa,as54;13,CHAPTER,configuration"
'
'Announce56:
'Befehl &HF0<n><m>
'liest announcements
'read m announcement lines
Data "240;an,ANNOUNCEMENTS;175;61;14,start at;14,elements;14,CHAPTER,ADMINISTRATION"
'
'Announce57:
'Befehl &HFC
...
Data "254;oa,INDIVIDUALIZATION;20,NAME,Device 1;b,NUMBER,1;a,I2C,1;b,ADRESS,14,{0 to 127};a,SERIAL,1;14,CHAPTER,ADMINISTRATION"
'
'Announce60:
'Befehl &HFF :
'eigene Individualisierung lesen
'read individualization
Data "255;aa,INDIVIDUALIZATION;20,NAME,Device 1;b,NUMBER,1;a,I2C,1;b,ADRESS,14,{0 to 127};a,SERIAL,1;b,BAUDRATE,0,{19200};3,NUMBER_OF_BITS,8n1;14,CHAPTER,ADMINISTRATION"