...
Data "0;m;DK1RI;crosspoint;V01.0;1;180;1;20"
'
'Announce1:
'Befehl &H01
'schaltet 1 Ausgang 8x8
'switch 1 output 8x8
Data "1;os,8x8;2,in,out;8;0,GND;1;2;3;4;5;6;7;8"
'
'Announce2:
'Befehl  &H02
'schaltet alle Ausgänge 8x8
'switch all outputs 8x8
Data "2;om,8x8;1;9,GND,1-8;lin;-;9,GND,1-8;lin;-;9,GND,1-8;lin;-;9,GND,1-8;lin;-;9,GND,1-8;lin;-;9,GND,1-8;lin;-;9,GND,1-8;lin;-;9,GND,1-8;lin;-"
'
'Announce3:
'Befehl &H03
'schaltet 1 Ausgang 8x4
'switch 1 output 8x4
Data "3;os,8x4;2,in,out;4;0,GND;1;2;3;4;5;6;7;8"
'
'Announce4:
'Befehl  &H04
'schaltet alle Ausgänge 8x4
'switch all outputs 8x4;1;9,GND,1-8;lin;-;9,GND,1-8;lin;-;9,GND,1-8;lin;-;9,GND,1-8;lin;-"
Data "4;om,8x4;1;10,off,GND,1-8;lin;-;10,off,GND,1-8;lin;-;10,off,GND,1-8;lin;-;10,off,GND,1-8;lin;-"
'
'Announce5:
'Befehl  &H05
'schaltet 1 Ausgang 4x4
'switch 1 output 4x4
Data "5;os,4x4;2,in,out;4;0,GND;1;2;3;4"
'
'Announce6:
'Befehl  &H06
'schaltet alle Ausgänge 4x4
'switch all outputs 4x4
Data "6;om,4x4;;1;5,GND,1-4;lin;-;5,GND,1-4;lin;-;5,GND,1-4;lin;-;5,GND,1-4;lin;-" 
'
'Announce7:
'Befehl  &H07
...
Data "240;ln,ANNOUNCEMENTS;180;18"
'
'Announce11:                                                  '
'Befehl &HFC
