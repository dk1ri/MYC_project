...
name = {}                       # name for display string: name of that device (devicegroup and indiv)
...
basic_commands = {}             # individual basic commands pr device
f255_name = {}                  # indivdualization per device
f255_number = {}                  # indivdualization per device
