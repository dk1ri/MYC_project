...
my_devices_dir=""				    #directory for my_devicex
my_devices_prefix=""				#prefix of my_devices filenames
devicegroup=""					    #location of devicegroupfiles
time_for_activ_check=0				#time in sec for checking weather a device is active
time_for_device_search=0			#ime in sec for searching for new devices
