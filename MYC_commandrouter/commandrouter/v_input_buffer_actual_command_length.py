...
#   0 type: 	x:no properties for command, no parameter for info; n: one numeric property; e: answer command or info not applicable,  error
#		        s: string; v: variable number of elements; t: for oa/aa command; u: for ob/ab command; c: for some metacommands,
...
#           4 n: length of complete data to wait for (commandtoken + length_of_number_of_elements + number_of_elements * length of number
